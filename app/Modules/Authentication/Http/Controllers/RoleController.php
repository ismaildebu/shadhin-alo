...
class RoleController
{
    ...
    public function update(UpdateRoleRequest $request, Role $role): JsonResponse
    {
        ...
        if ($request->has('permissions')) {
            $role->permissions()->sync(
                \App\Modules\Authorization\Models\Permission::whereIn('slug', $request->input('permissions', []))
                    ->pluck('id')
                    ->toArray()
            );
        }
    ...
    public function assignPermissions(Role $role, StoreRoleRequest $request): JsonResponse
    {
        $this->authorize('update', $role);
